    ...
    <>
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-text-muted dark:text-text-body-dark max-w-3xl">
          Read latest judgments and legal principles on Fundamental Rights Enforcement procedure.
        </p>
      </div>
      ...
      {authorities.length === 0 ? (
        <div className="text-center py-16 bg-white dark:bg-midnight-light border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm">
          ...
          <h3 className="text-lg font-medium text-navy dark:text-text-heading-dark">No New Authorities Available</h3>

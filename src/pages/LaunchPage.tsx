...
export default function LaunchPage() {
  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-midnight text-text-body dark:text-text-body-dark flex flex-col justify-between py-8 px-4 sm:px-6 lg:px-8">
      {/* Top Header */}
      <header className="max-w-4xl mx-auto w-full flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4 mb-8">
      ...
      <main className="max-w-4xl mx-auto w-full flex-1 flex flex-col justify-center items-center">
        ...
        {/* Conference Badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-navy/10 dark:bg-navy-light/40 border border-navy/20 dark:border-gold/30 text-navy dark:text-gold-light text-xs font-semibold uppercase tracking-wider mb-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="text-base sm:text-lg text-text-body dark:text-text-body-dark leading-relaxed">
        ...
        <div className="relative group w-full max-w-[200px] sm:max-w-[240px] mb-10 flex justify-center">
          <div className="relative w-full transition-transform duration-500 ease-out [transform-style:preserve-3d] [transform:rotateX(2deg)_rotateY(-4deg)] group-hover:[transform:rotateX(0deg)_rotateY(0deg)]">
            <img
              ...
              className="w-full h-auto rounded shadow-2xl shadow-slate-900/30 dark:shadow-black/70 dark:ring-1 dark:ring-white/10 object-cover"
            />
        ...
        {isLocked ? (
          <div className="w-full max-w-xl mb-12">
            <h2 className="text-xs sm:text-sm font-bold uppercase tracking-widest text-text-muted dark:text-text-body-dark text-center mb-4">
            ...
            <div className="grid grid-cols-4 gap-2 sm:gap-4 text-center">
              {[
                ...
                <div
                  key={label}
                  className="bg-navy dark:bg-midnight-light border border-white/10 dark:border-slate-800 rounded-xl p-3 sm:p-4 shadow-lg flex flex-col items-center justify-center"
                >
                  <span className="text-2xl sm:text-4xl font-serif font-bold text-gold dark:text-gold-light tracking-tight">
        ...
        <div className="w-full max-w-2xl bg-surface-alt dark:bg-midnight-light border border-slate-200 dark:border-slate-800 rounded-2xl p-6 sm:p-8 shadow-sm flex flex-col md:flex-row items-center gap-8 justify-between">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-xs sm:text-sm text-text-body dark:text-text-body-dark leading-relaxed mb-4">
              Install as a Progressive Web App (PWA) for 100% offline access—no app store download required.
            </p>

            {isIOS ? (
              <div className="bg-slate-200/60 dark:bg-slate-800 p-3 rounded-lg border border-slate-300 dark:border-slate-700 text-xs text-text-body dark:text-text-body-dark leading-relaxed">
          ...
          <div className="flex flex-col items-center shrink-0">
            ...
            <span className="text-[11px] font-medium text-text-muted mt-2 text-center max-w-[160px]">
      ...
      {/* Footer */}
      <footer className="max-w-4xl mx-auto w-full border-t border-slate-200 dark:border-slate-800 pt-6 mt-12 text-center text-xs text-text-muted">
        Powered by{' '}
        <a
